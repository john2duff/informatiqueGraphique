...
#undef V
    ...
    double n1[]={ 0.0, 1.0, 0.0};
    affiche_vecteur(o,n1,c);
    double n2[]={ 0.0, 0.0, 1.0};
    affiche_vecteur(o,n2,c);
    double n3[]={-1.0, 0.0, 0.0};
    affiche_vecteur(o,n3,c);
    double n4[]={0.0,-1.0, 0.0};
    affiche_vecteur(o,n4,c);
    double n5[]={0.0, 0.0,-1.0};
    affiche_vecteur(o,n5,c);
}
